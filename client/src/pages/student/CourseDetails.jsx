  ...
  return courseData ? (
    ...
    >
      ...
      <div className="max-w-xl z-10 text-gray-500">
        ...
        <p className="text-sm">
          Course By <span className="text-blue-600 underline">LMSWEB</span>
        </p>
            ...
            {courseData.courseContent.map((chapter, index) => (
              ...
              >
                <div className="flex items-center justify-between px-4
                 py-3 cursor-pointer select-none" onClick={()=>toggleSection(index)}>
      ...
      md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
        ...
        <div className='p-5'>
          <div className='flex items-center gap-2'>
            ...
            <p className='text-red-500'><span className='font-medium'>5days</span> left at this price</p>
            </div>
